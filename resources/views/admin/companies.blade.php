                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-[640px] w-full text-sm">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-center font-semibold text-gray-700 dark:text-gray-200">Users</th>
                                ...
                                @foreach ($companies as $company)
                                    <tr class="hover:bg-gray-50/70 dark:hover:bg-gray-700/20">
                                        <td class="px-4 py-3 text-gray-600 dark:text-gray-300">{{ $company->id }}</td>
                                        <td class="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">{{ $company->name }}</td>
                                        <td class="px-4 py-3 text-center text-gray-700 dark:text-gray-200">{{ $company->users_count }}</td>
