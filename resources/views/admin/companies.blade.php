                ...
                <div class="p-6">
                    ...
                    <table class="min-w-full border-collapse border border-gray-300 dark:border-gray-900">
                        ...
                        <tr>
                            ...
                            <th class="border border-gray-300 dark:border-gray-900 px-4 py-2">Users</th>
                        ...
                        @foreach ($companies as $company)
                            <tr>
                                <td class="border border-gray-300 dark:border-gray-900 px-4 py-2">{{ $company->id }}</td>
                                <td class="border border-gray-300 dark:border-gray-900 px-4 py-2">{{ $company->name }}</td>
                                <td class="border border-gray-300 dark:border-gray-900 px-4 py-2 text-center">{{ $company->users_count }}</td>
